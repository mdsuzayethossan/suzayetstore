    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-sm-4 col-md-4 col-lg-4 col-xl-3">
                <a href="#" class="btn btn-primary btn-block" data-toggle="modal" data-target="#add_role"><i class="fa fa-plus"></i> Role & Permission Assign</a>
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('role.permission.assign') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" placeholder="Moderator">
                        </div>
                        <div class="table-responsive m-t-15">
                            <table class="table table-striped custom-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $role_permission_name->name }}</td>
                                        <td class="text-center">
