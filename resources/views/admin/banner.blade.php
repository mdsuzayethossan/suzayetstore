            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_employee"><i class="fa fa-plus"></i> Add Banner</a>
                ...
                <div class="col-12 col-md-6 col-lg-6 d-flex">
                    <div class="card flex-fill">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title mb-0">Smart blood</h5>
                            <h5 class="card-title mb-0">Pressure monitor</h5>
                            <p class="card-text">The best gadgets collection 2021.</p>
                            <del>$430.00</del>
                        <span>$350.00</span><br/>
                        <a class="btn btn-primary class m-t-10" href="#">Go somewhere</a>
                        </div>
                    </div>
                </div>
